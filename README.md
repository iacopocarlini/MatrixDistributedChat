...
# Deployment
If you are up to apply your personal changes to the app and then deploy it  (Web, Android, iOS), check this [guide](https://capacitorjs.com/docs/getting-started/with-ionic)
